...
type BeginActivationRequest struct {
	...
	// Optional reader-only ancestry for model/tool activations inside agents.
	// Never participates in activation identity, input/definition digests, or
	// replay decisions. Bounded to 256 UTF-8 bytes.
	DisplayParentCorrelationId string `protobuf:"bytes,15,opt,name=display_parent_correlation_id,json=displayParentCorrelationId,proto3" json:"display_parent_correlation_id,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *BeginActivationRequest) GetDisplayParentCorrelationId() string {
	if x != nil {
		return x.DisplayParentCorrelationId
	}
	return ""
}
...
const file_api_v1_engine_proto_rawDesc = "" +
	...
	"\n" +
	"input_data\x18\x0e \x01(\fR\tinputData\x12A\n" +
	"\x1ddisplay_parent_correlation_id\x18\x0f \x01(\tR\x1adisplayParentCorrelationId\"\xd5\x02\n" +
